...
public class Registration_Flow {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		driver.findElement(By.id("usercentrics-root")).getShadowRoot()
				.findElement(By.xpath("div:nth-child(1) > div:nth-child(2) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > button:nth-child(2)")).click();
        */
		//-------------------------PLP Page-----------------------------
		...
		Email.sendKeys("jkhyrf450@yopmail.com");
